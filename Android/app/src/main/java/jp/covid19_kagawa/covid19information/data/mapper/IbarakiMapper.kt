...
object IbarakiMapper {
    ...
    fun getInspectionData(data: IbarakiData): List<InspectionData> {
        ...
        val count = minOf(rootData.count(), countData.count())
    ...
    fun getInfectionData(data: IbarakiData): InfectionSummary {
        //ここのvalueで検査人数
    ...
    fun getInspectionSummaryData(data: IbarakiData): InspectionSummary {
        //ここの人数で検査実施人数
    ...
    fun getInspectionDetailData(data: IbarakiData): List<InspectionDetailSummary> {
    ...
    fun getContactData(data: IbarakiData): ContactData {
    ...
    fun getEntranceData(data: IbarakiData): EntranceData {
