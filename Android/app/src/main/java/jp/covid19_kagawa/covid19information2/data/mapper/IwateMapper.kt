...
object IwateMapper {
    ...
    fun getInspectionData(data: IwateData): List<InspectionData> {
    ...
    fun getInfectionData(data: IwateData): InfectionSummary {
        //ここのvalueで検査人数
    ...
    fun getInspectionSummaryData(data: IwateData): InspectionSummary {
        //ここの人数で検査実施人数
    ...
    fun getInspectionDetailData(data: IwateData): List<InspectionDetailSummary> {
    ...
    fun getContactData(data: IwateData): ContactData {
    ...
    fun getEntranceData(data: IwateData): EntranceData {
