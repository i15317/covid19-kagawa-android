package jp.covid19_kagawa.covid19information2.ui.dashboard
...
import jp.covid19_kagawa.covid19information2.MyValueFormatter
import jp.covid19_kagawa.covid19information2.R
import jp.covid19_kagawa.covid19information2.XYMarkerView
import jp.covid19_kagawa.covid19information2.actioncreator.ChartActionCreator
import jp.covid19_kagawa.covid19information2.entity.InspectionData
import jp.covid19_kagawa.covid19information2.observe
import jp.covid19_kagawa.covid19information2.store.ChartStore
...
//        yl.setInverted(true);
    ...
    private fun updateGraph(src: List<InspectionData>) {
        ...
        if (chart.data != null &&
            ...
            set1 = BarDataSet(values, "ＰＣＲ検査受診数")
